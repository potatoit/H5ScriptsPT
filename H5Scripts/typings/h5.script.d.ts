...
interface IContentElement {
	...
	Append(element: JQuery, parent: JQuery): void;
...
declare class ListControl {
	...
	public static RenderDataGrid(list: IList, columns: any[], rows: any[], options: object);
}
...
declare class H5ControlDialog {
	HasDialogInstance(dialogId: string): boolean;
	AddDialogInstance(dialogId: string): boolean;
	RemoveDialogInstance(dialogId: string): any;
	DestroyDialog(dialogContent: JQuery, isRemoveInstance?: boolean);
	CreateDialogElement(content: HTMLElement, dialogOptions: any);
}
